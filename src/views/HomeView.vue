    ...
    <SectionMain>
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6">
        ...
        <CardBoxWidget
          ...
          label="Học sinh"
        />
        <CardBoxWidget color="text-red-500" :icon="mdiBookAccount" :number="statistics.total_course" label="Khóa học" />
        <CardBoxWidget
        ...
        />
        <CardBoxWidget color="text-slate-500" :icon="mdiNoteEdit" :number="statistics.total_post" label="Bài viết" />
        <CardBoxWidget
